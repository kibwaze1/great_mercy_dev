...
<body>
    ...
    <div class="top-navbar-white">
        ...
        <div class="right-group">
            <div class="links-right">
                ...
                <a href="{{ route('alumni.index') }}" target="_blank">Alumni</a>
                <a href="{{ route('school.students') }}">Students</a>
                <a href="{{ route('school.staff') }}">Staff & Faculty</a>
                <a href="#">Quicklinks</a>
            </div>
    ...
    <div class="main-navbar-blue">
        ...
        <div class="nav-links" id="desktopNavLinks">
            <a href="{{ route('school.home') }}" class="@yield('nav-home')">Home</a>
    ...
    <footer class="school-footer">
        <div class="footer-content">
            <div class="footer-links">
                ...
                <a href="{{ route('orphanage.home') }}">Orphanage</a>
                <a href="{{ route('school.home') }}">School</a>
                <a href="{{ route('clinic.home') }}">Clinic</a>
            </div>
