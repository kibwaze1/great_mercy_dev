...
@section('title', 'Home - Great Mercy School')

@section('nav-home', 'active')

@section('content')
    <!-- Hero Section -->
    <section class="school-hero" style="background-image: url('{{ $heroUrl ?? asset('images/hero_school.jpg') }}');">
        ...
        <div class="school-hero-content">
            ...
            <a href="{{ route('school.apply') }}" class="hero-btn">Apply Now</a>
        </div>
    </section>
