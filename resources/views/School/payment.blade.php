...
<div class="page">
    ...
    <form method="POST" action="{{ route('school.payment.initiate', $application) }}" class="payment-form">
        @csrf
        <div class="form-group">
            <label for="phone">M-Pesa Phone Number (e.g., 254712345678) *</label>
            <input type="tel" name="phone" id="phone" placeholder="254712345678" value="{{ old('phone') }}" required>
