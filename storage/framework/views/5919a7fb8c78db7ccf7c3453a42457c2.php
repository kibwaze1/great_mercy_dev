...
<?php $__env->startSection('content'); ?>
    <!-- Hero Section -->
    <section class="hero">
        <img src="<?php echo e($heroUrl ?? asset('hero.jpeg')); ?>" alt="Great Mercy campus" class="hero-image">
        <div class="hero-content">
            <h1>Welcome to Great Mercy</h1>
            <div class="hero-logo">
                <img src="<?php echo e(asset('logo.png')); ?>" alt="Great Mercy Logo">
            </div>
    ...
    <section class="section">
        ...
        <div class="cards">
            <div class="card" onclick="window.open('<?php echo e(route('school.home')); ?>', '_blank')"><h3>🏢 School</h3><p>To nurture all round competent and transformed children that make a difference in the community.</p></div>
            <div class="card" onclick="window.open('<?php echo e(route('orphanage.home')); ?>', '_blank')"><h3>🏠 Orphanage</h3><p>Providing shelter, education, food and spiritual nourishment to orphaned and vulnerable children.</p></div>
            <div class="card" onclick="window.open('<?php echo e(route('clinic.home')); ?>', '_blank')"><h3>🏥 Clinic</h3><p>Healthy communities, Healthy futures.</p></div>
            <div class="card" onclick="window.open('<?php echo e(route('chapel.home')); ?>', '_blank')"><h3>⛪ Chapel</h3><p>Light, Love and Life in Christ.</p></div>
        </div>
    </section>
            ...
            <?php if($news->count() > 0): ?>
                ...
                <div class="home-news-card">
                    ...
                    <div class="home-news-body">
                        ...
                        <p><?php echo e(Str::limit($item->content, 100)); ?></p>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (homeProgramBtn) {
            homeProgramBtn.addEventListener('click', function() {
                window.location.href = "<?php echo e(route('home.program')); ?>";
            });
        }

        if (schoolProgramBtn) {
            schoolProgramBtn.addEventListener('click', function() {
                window.location.href = "<?php echo e(route('school.program')); ?>";
            });
        }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC\great-mercy\resources\views/home.blade.php ENDPATH**/ ?>